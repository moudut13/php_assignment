        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
            ...
            <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                ...
                <ul class="navbar-nav ms-auto d-flex align-items-center">
                    ...
                    <!-- ============================================================== -->
                    <li class=" in">
                        <form role="search" class="app-search d-none d-md-block me-3" method="GET" action="">
                            <input name="srt" type="text" placeholder="Search..." class="form-control mt-0">
                            <input name="srtbtn" class="btn btn-sm-4 btn-primary" style="border-radius: 20px;" type="submit" value="Search">
                        </form>
                    </li>
                    <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="white-box">
                        <div class="float-lg-start"><h2 class="">View All Students</h2></div>
                        <div class="float-lg-end"><a class="btn btn-primary" href="add-student.php">Add Student</a></h2></div>
                        <div class="float-lg-none"><h2 class=""></div>
                        <table class="table table-striped">
                            ...
                            <?php
                                ...
                                if (isset($_GET['srtbtn'])){
                                    //$search = $_GET['srt'];
                                    $sqlserch = "SELECT * FROM students WHERE name LIKE '%Shuvo%'";
                                    $data = $config->query($sqlserch);
                            ...
                            <tr>
                                ...
                                <td><a href="student-edit.php?edit=<?php echo $row->id;?>" class="btn bg-success">Edit</a><br><a href="student-view.php?view=<?php echo $row->id?>" class="btn bg-primary">View</a><br><a href="?trash=<?php echo $row->id;?>" class="btn btn-danger">Trash</a></td>
                            </tr>
                            <?php endif; endwhile;?>
                            </tbody>
                        </table>
