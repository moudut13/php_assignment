...
<?php
    if (isset($_GET['edit'])){
        $edit = $_GET['edit'];
        $row = singleDataView('students',$edit);
        if (isset($_POST['update'])){
            echo $name = $_POST['name'];
            $email = $_POST['email'];
            $cell = $_POST['cell'];
            $location = $_POST['location'];
            $sql = "UPDATE students SET name='shuvo' WHERE id=$edit";
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Page <?php echo $row->username;?></h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="#" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Cell</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $row->cell;?>" name="cell" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Location</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $row->location;?> " name="location" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <div class="col-sm-12">
                                            <input value="Update Profile" name="update" type="submit" class="btn btn-primary">
                                        </div>
                                    </div>
                                </form>
                            </div>
