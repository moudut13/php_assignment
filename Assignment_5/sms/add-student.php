                ...
                <!-- Row -->
                    ...
                    <?php
                        if (isset($_POST['add'])){
                            ...
                            $class = $_POST['class'];
                            $photo = $_FILES['photo'];
                            $photo_name = imageUnique($photo,'assets/images/students/');
                            if (empty($name) || empty($email) || empty($username)){
                                $msg = valid("All Fields are Required");
                            }elseif (filter_var($email, FILTER_VALIDATE_EMAIL) == false){
                                $msg = valid("Please Enter Your Email");
                            } else{
                                $sql = "INSERT INTO students (name,username,email,cell,location,class,photo) VALUES('$name','$username','$email','$cell','$location','$class','$photo_name')";
                                create($sql);
                                ...
                                <form class="form-horizontal form-material" action="#" method="POST" enctype="multipart/form-data">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="name" type="text" placeholder="Your Name" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">User Name</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="username" type="text" placeholder="User Name" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Email</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="email" type="text" placeholder="Your Email" class="form-control p-0 border-0" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Phone No</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="cell" type="text" placeholder="Your Phone Number"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="location" type="text" placeholder="Your Location" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <select name="class" class="form-select shadow-none p-0 border-0 form-control-line">
                                    ...
                                    <div class="mb-4">
                                        <div class="col-sm-12">
                                            <input value="Add Profile" name="add" type="submit" class="btn btn-primary col-lg-4 mx-auto">
                                        </div>
                                    </div>
                                </form>
                            </div>
