        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="white-box">
                        <div class="float-lg-start"><h2 class="">View All Staff</h2></div>
                        <div class="float-lg-end"><a class="btn btn-primary" href="add-staff.php">Add Staff</a></h2></div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td><a href="staff-edit.php?edit=<?php echo $row->id;?>" class="btn bg-success">Edit</a><a href="staff-view.php?view=<?php echo $row->id?>" class="btn bg-primary">View</a><a href="?trash=<?php echo $row->id;?>" class="btn btn-danger">Trash</a></td>
                            </tr>
                            <?php endif; endwhile;?>
                            </tbody>
                        </table>
