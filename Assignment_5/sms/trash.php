        ...
        <div class="page-breadcrumb bg-white">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Trash Box</h4>
                </div>
                        ...
                        <table class="table table-striped">
                            ...
                            while ($rows = $results->fetch_object()):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rows->cell;?></td>
                                    <td><?php echo $rows->class;?></td>
                                    <td><img style="width: 60px;" src="assets/images/students/<?php echo $rows->photo;?>"></td>
                                    <td><a href="?restore=<?php echo $rows->id;?>" class="btn btn-primary">Restore</a><a href="?delete=1" class="btn btn-danger">Delete</a></td>
                                </tr>
                            <?php endif; endwhile;?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-striped">
                            ...
                            while ($row = $teacher->fetch_object()):
                                ...
                                <tr>
                                    ...
                                    <td><a href="?restore=<?php echo $row->id;?>" class="btn btn-primary">Restore</a><a href="?delete=1" class="btn btn-danger">Delete</a></td>
                                </tr>
                            <?php endif; endwhile;?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-striped">
                            ...
                            while ($row = $staff->fetch_object()):
                                ...
                                <tr>
                                    ...
                                    <td><a href="?restore=<?php echo $row->id;?>" class="btn btn-primary">Restore</a><a href="?delete=<?php echo $row->id;?>" class="btn btn-danger">Delete</a></td>
                                </tr>
                            <?php endif; endwhile;?>
                            </tbody>
                        </table>
